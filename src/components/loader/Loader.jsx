        ...
        >
          <div className="flex items-center justify-center p-5 w-24 h-24 bg-gray-700/80 rounded-md">
            <div className="relative w-12 h-12">
              ...
              {/* Inner counter-rotating ring (white) */}
              <span className="absolute inset-0 w-8 h-8 border-l-4 border-b-4 border-white rounded-full animate-reverseRotation top-2 left-2"></span>
            </div>
          </div>
        </div>
      ) : (
